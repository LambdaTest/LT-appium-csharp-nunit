...
namespace NUnitSelenium
{
    ...
    [TestFixture("OnePlus 6", "8", "Android", "lt://APP10160531401657178216019631")]
    ...
    public class NUnitSeleniumSample
    {
        ...
        public void Init()
        {
            ...
            capabilities.AddAdditionalCapability("user", "garvits");
            capabilities.AddAdditionalCapability("accessKey", "YjstUAGma4yzUhJUo0jH0aoYVjlfYokappBzEPvsSCOCcGcocy");
